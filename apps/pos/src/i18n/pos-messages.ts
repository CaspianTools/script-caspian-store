...
export const POS_MESSAGES_EN: MessageDict = {
  ...
  'pos.ticket.clearTitle': 'Clear this sale?',
  'pos.ticket.clearVerb': 'Clear the sale',
  'pos.ticket.clearDetail': '{count, plural, one {# line} other {# lines}}, {total}. Nothing is recorded.',
  'pos.admin.products.deleteTitle': 'Remove this item?',
  'pos.admin.people.deleteTitle': 'Remove this person?',
  'pos.store.category.deleteTitle': 'Remove this group?',
  'pos.store.supplier.deleteTitle': 'Remove this supplier?',
  'pos.store.receive.discardTitle': 'Throw this delivery away?',
  'pos.terminal.newCodeTitle': 'Give this counter a new code?',
  'pos.terminal.removeTitle': 'Remove this counter?',
  'pos.appAdmin.deleteRoleTitle': 'Delete this role?',
  'pos.admin.backup.restoreVerb': 'Restore this file',
  'pos.admin.backup.restoreWord': 'restore',
  'pos.admin.backup.restoreGate': 'Type {word} to confirm',
  'pos.appAdmin.deleteRoleGate': 'Type {name} to confirm',
  ...
  // Returns (v2.0.0)
  'pos.appAdmin.capability.sales.refund': 'Give money back',
  'pos.receipt.reprint': 'Copy of a receipt already given',
  'pos.refund.allReturned': 'All back',
  'pos.refund.confirm': 'Give back {amount}',
  'pos.refund.confirmEmpty': 'Give back',
  'pos.refund.done': 'Return recorded as {receipt}',
  'pos.refund.error.already-refund': 'A return cannot itself be returned.',
  'pos.refund.error.no-original': 'That sale is no longer on this till.',
  'pos.refund.error.nothing-returnable': 'Everything on this sale has already come back.',
  'pos.refund.error.unavailable': 'This computer’s records could not be opened.',
  'pos.refund.note': 'Note',
  'pos.refund.noteHelp': 'Optional. Kept on the record with the return.',
  'pos.refund.nothingPicked': 'Pick at least one thing first.',
  'pos.refund.payBack': 'Pay back with',
  'pos.refund.reason': 'Why',
  'pos.refund.reason.changed-mind': 'Changed their mind',
  'pos.refund.reason.faulty': 'Faulty',
  'pos.refund.reason.other': 'Something else',
  'pos.refund.reason.overcharged': 'Charged too much',
  'pos.refund.reason.wrong-item': 'Wrong item',
  'pos.refund.returnable': 'Can come back',
  'pos.refund.returning': 'Coming back',
  'pos.refund.start': 'Take something back',
  'pos.refund.subtitle': 'From receipt {receipt}. Pick what is coming back.',
  'pos.refund.summary': 'Going back to the customer',
  'pos.refund.title': 'Take something back',
  'pos.sale.backToSales': 'Back to sales',
  'pos.sale.figures': 'Figures',
  'pos.sale.isRefundOf': 'This is a return against receipt {receipt}.',
  'pos.sale.lines': 'What was bought',
  'pos.sale.missing': 'That sale is not on this till.',
  'pos.sale.pageSubtitle': 'Everything on it, and everything that has happened since.',
  'pos.sale.pageTitle': 'This sale',
  'pos.sale.refunded': 'Given back',
  'pos.sale.refundsAgainst': 'Returns against this sale',
  'pos.sale.reprint': 'Print this again',
  'pos.sale.returned': 'Returned',
  'pos.sale.tenders': 'How it was paid',
  'pos.shift.net': 'Net',
  ...
  'pos.discount.byCashier': 'By cashier',
  'pos.discount.byReason': 'By reason',
  'pos.discount.reason': 'Why?',
  'pos.discount.reason.damaged': 'Damaged',
  'pos.discount.reason.goodwill': 'Goodwill',
  'pos.discount.reason.loyalty': 'Regular customer',
  'pos.discount.reason.other': 'Something else',
  'pos.discount.reason.price-match': 'Price match',
  'pos.discount.reason.staff': 'Staff',
  'pos.discount.reason.unrecorded': 'No reason recorded',
  'pos.discount.reasonRequired': 'Pick a reason for the discount first.',
  'pos.discount.sectionTitle': 'Discounts',
  'pos.lock.pin': 'PIN',
  'pos.lock.pinLocked': 'Five wrong PINs. The PIN is switched off until your password unlocks this screen once.',
  'pos.lock.usePassword': 'Use my password instead',
  'pos.lock.usePin': 'Use my PIN instead',
  'pos.lock.wrongPin': 'That PIN is not right.',
  'pos.pin.body': 'A short code that reopens a locked screen. Signing in still takes your password — the PIN never replaces it.',
  'pos.pin.changeTitle': 'Change the unlock PIN',
  'pos.pin.confirmPin': 'Type it again',
  'pos.pin.help': 'A PIN reopens the locked screen without the full password. It never signs anyone in, and five wrong tries switch it off until the password works once.',
  'pos.pin.mismatch': 'The two PINs do not match.',
  'pos.pin.newPin': 'New PIN — {min} digits or more',
  'pos.pin.passwordFirst': 'Type your password first.',
  'pos.pin.remove': 'Remove the PIN',
  'pos.pin.removed': 'PIN removed',
  'pos.pin.saved': 'PIN set',
  'pos.pin.setTitle': 'Set an unlock PIN',
  'pos.pin.shape': 'Digits only, at least {min} of them.',
  'pos.pin.weak': 'Too easy to guess — not all one digit, and not a run like 123456.',
};
