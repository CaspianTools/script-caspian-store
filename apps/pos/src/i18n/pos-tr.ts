...
const tr: MessageDict = {
  ...
  'pos.discount.byCashier': 'Kasiyere göre',
  'pos.discount.byReason': 'Nedene göre',
  'pos.discount.reason': 'Neden?',
  'pos.discount.reason.damaged': 'Hasarlı',
  'pos.discount.reason.goodwill': 'İyi niyet',
  'pos.discount.reason.loyalty': 'Düzenli müşteri',
  'pos.discount.reason.other': 'Başka bir neden',
  'pos.discount.reason.price-match': 'Fiyat eşleştirme',
  'pos.discount.reason.staff': 'Personel',
  'pos.discount.reason.unrecorded': 'Neden kaydedilmemiş',
  'pos.discount.reasonRequired': 'Önce indirimin nedenini seçin.',
  'pos.discount.sectionTitle': 'İndirimler',
  'pos.lock.pin': 'PIN',
  'pos.lock.pinLocked': 'Beş yanlış PIN. Parolanız bu ekranı bir kez açana kadar PIN kapalı.',
  'pos.lock.usePassword': 'Parolamı kullan',
  'pos.lock.usePin': 'PIN kullan',
  'pos.lock.wrongPin': 'Bu PIN doğru değil.',
  'pos.pin.body': 'Kilitli ekranı açan kısa bir kod. Oturum açmak yine parola ister — PIN onun yerine geçmez.',
  'pos.pin.changeTitle': 'Kilit açma PIN’ini değiştir',
  'pos.pin.confirmPin': 'Bir daha yazın',
  'pos.pin.help': 'PIN, kilitli ekranı tam parola olmadan açar. Kimseyi oturuma sokmaz ve beş yanlış denemeden sonra parola bir kez çalışana kadar kapanır.',
  'pos.pin.mismatch': 'İki PIN uyuşmuyor.',
  'pos.pin.newPin': 'Yeni PIN — en az {min} rakam',
  'pos.pin.passwordFirst': 'Önce parolanızı yazın.',
  'pos.pin.remove': 'PIN’i kaldır',
  'pos.pin.removed': 'PIN kaldırıldı',
  'pos.pin.saved': 'PIN belirlendi',
  'pos.pin.setTitle': 'Kilit açma PIN’i belirle',
  'pos.pin.shape': 'Yalnızca rakam, en az {min} tane.',
  'pos.pin.weak': 'Tahmini çok kolay — hepsi aynı rakam ya da 123456 gibi bir dizi olmasın.',
};
