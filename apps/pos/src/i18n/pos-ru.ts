...
const ru: MessageDict = {
  ...
  // the unlock PIN and the discount reason (v2.1.0)
  'pos.discount.byCashier': 'По кассиру',
  'pos.discount.byReason': 'По причине',
  'pos.discount.reason': 'Почему?',
  'pos.discount.reason.damaged': 'Повреждён',
  'pos.discount.reason.goodwill': 'Жест доброй воли',
  'pos.discount.reason.loyalty': 'Постоянный покупатель',
  'pos.discount.reason.other': 'Другое',
  'pos.discount.reason.price-match': 'Сравнение цены',
  'pos.discount.reason.staff': 'Сотрудник',
  'pos.discount.reason.unrecorded': 'Причина не записана',
  'pos.discount.reasonRequired': 'Сначала выберите причину скидки.',
  'pos.discount.sectionTitle': 'Скидки',
  'pos.lock.pin': 'PIN-код',
  'pos.lock.pinLocked': 'Пять неверных PIN-кодов. PIN отключён, пока пароль один раз не откроет этот экран.',
  'pos.lock.usePassword': 'Ввести пароль',
  'pos.lock.usePin': 'Ввести PIN-код',
  'pos.lock.wrongPin': 'Этот PIN-код не подходит.',
  'pos.pin.body': 'Короткий код, открывающий заблокированный экран. Вход по-прежнему требует пароль — PIN его никогда не заменяет.',
  'pos.pin.changeTitle': 'Сменить PIN-код разблокировки',
  'pos.pin.confirmPin': 'Введите ещё раз',
  'pos.pin.help': 'PIN-код открывает заблокированный экран без полного пароля. Он никого не впускает в систему, а после пяти неверных попыток отключается, пока пароль не сработает один раз.',
  'pos.pin.mismatch': 'PIN-коды не совпадают.',
  'pos.pin.newPin': 'Новый PIN — не меньше {min} цифр',
  'pos.pin.passwordFirst': 'Сначала введите пароль.',
  'pos.pin.remove': 'Удалить PIN-код',
  'pos.pin.removed': 'PIN-код удалён',
  'pos.pin.saved': 'PIN-код задан',
  'pos.pin.setTitle': 'Задать PIN-код разблокировки',
  'pos.pin.shape': 'Только цифры, не меньше {min}.',
  'pos.pin.weak': 'Слишком просто угадать — не все одинаковые цифры и не ряд вроде 123456.',
};
