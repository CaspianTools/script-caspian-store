...
const az: MessageDict = {
  ...
  'pos.discount.byCashier': 'Kassirə görə',
  'pos.discount.byReason': 'Səbəbə görə',
  'pos.discount.reason': 'Səbəb?',
  'pos.discount.reason.damaged': 'Zədəli',
  'pos.discount.reason.goodwill': 'Xoş məram',
  'pos.discount.reason.loyalty': 'Daimi müştəri',
  'pos.discount.reason.other': 'Başqa səbəb',
  'pos.discount.reason.price-match': 'Qiymət uyğunlaşdırması',
  'pos.discount.reason.staff': 'İşçi',
  'pos.discount.reason.unrecorded': 'Səbəb qeyd olunmayıb',
  'pos.discount.reasonRequired': 'Əvvəlcə endirimin səbəbini seçin.',
  'pos.discount.sectionTitle': 'Endirimlər',
  'pos.lock.pin': 'PIN',
  'pos.lock.pinLocked': 'Beş dəfə səhv PIN. Parolunuz bu ekranı bir dəfə açana qədər PIN söndürülüb.',
  'pos.lock.usePassword': 'Parolumla açım',
  'pos.lock.usePin': 'PIN ilə açım',
  'pos.lock.wrongPin': 'Bu PIN düzgün deyil.',
  'pos.pin.body': 'Kilidli ekranı açan qısa kod. Daxil olmaq yenə paroldadır — PIN onu heç vaxt əvəz etmir.',
  'pos.pin.changeTitle': 'Açma PIN-ini dəyiş',
  'pos.pin.confirmPin': 'Bir də yazın',
  'pos.pin.help': 'PIN kilidli ekranı tam parol olmadan açır. Heç kimi daxil etmir, beş səhv cəhddən sonra isə parol bir dəfə işləyənə qədər söndürülür.',
  'pos.pin.mismatch': 'İki PIN uyğun gəlmir.',
  'pos.pin.newPin': 'Yeni PIN — ən azı {min} rəqəm',
  'pos.pin.passwordFirst': 'Əvvəlcə parolunuzu yazın.',
  'pos.pin.remove': 'PIN-i sil',
  'pos.pin.removed': 'PIN silindi',
  'pos.pin.saved': 'PIN təyin olundu',
  'pos.pin.setTitle': 'Açma PIN-i təyin et',
  'pos.pin.shape': 'Yalnız rəqəm, ən azı {min} dənə.',
  'pos.pin.weak': 'Tapması çox asandır — hamısı eyni rəqəm və ya 123456 kimi ardıcıllıq olmasın.',
};
