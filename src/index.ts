...
// The field (de)serialisers the import/export catalog is built on. Public
// because the standalone till's CSV round-trip has to agree with the store's
// down to how a stock map or a boolean is spelled, and it lives in a separate
// package now -- two copies of these would drift the first time one changed.
export {
  joinList,
  parseList,
  joinStock,
