...
export const DEFAULT_MESSAGES: MessageDict = {
  ...
  'admin.products.validation.pricePositive': 'Enter a price greater than 0.',
  ...
  'admin.products.validation.colorNameRequired': 'Give this colour a name.',
  'admin.products.validation.colorNameDuplicate': 'Another colour already uses this name.',
  'admin.products.validation.colorImageRequired': 'Add an image for this colour.',
  'admin.products.validation.fixErrors': 'Fix the highlighted fields before saving.',
  'admin.products.colors.title': 'Colour variants',
  'admin.products.colors.hint':
    'Each colour shows as an image swatch on the product page; picking one swaps the gallery to its image. The first colour is selected by default.',
  'admin.products.colors.name': 'Colour name',
  'admin.products.colors.namePlaceholder': 'e.g. Black',
  'admin.products.colors.image': 'Swatch image',
  'admin.products.colors.add': 'Add colour',
  'admin.products.colors.remove': 'Remove',
  'admin.products.colors.moveUp': 'Move colour up',
  'admin.products.colors.moveDown': 'Move colour down',
  ...
  'admin.products.review.colors': 'Colour variants',
