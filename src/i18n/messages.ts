...
export const DEFAULT_MESSAGES: MessageDict = {
  ...
  'storefront.stock.inStock': 'In stock',
  'storefront.stock.lowStock': 'Low stock',
  'storefront.stock.outOfStock': 'Out of stock',
  'storefront.stock.outShort': 'Out',
  'storefront.stock.outOfStockNotify': 'Out of stock — get in touch to be notified',
  ...
  // --- Admin shell chrome (v15.1.0: aria labels were hardcoded English) ---
  'admin.shell.navLabel': 'Admin navigation',
  'admin.shell.openMenu': 'Open menu',
  'admin.shell.closeMenu': 'Close menu',
  'admin.shell.collapseSidebar': 'Collapse sidebar',
  'admin.shell.expandSidebar': 'Expand sidebar',
  'admin.shell.updateAvailable': 'Update available',
  ...
  'checkout.error.noProvider': 'No payment provider is configured. Ask an admin to install a payment plugin.',
  'checkout.error.failed': 'Checkout failed.',
  'checkout.guestSignInFailed': 'Could not start guest checkout',
  'checkout.createAccountLink': 'Create an account',
  'checkout.accountNotCreated.title': 'Account not created',
  'checkout.accountNotCreated.emailInUse':
    'An account with that email already exists. Sign in to attach this order to it, or continue as guest.',
  'checkout.accountNotCreated.fallback': 'Could not create your account — continuing as guest.',
  'checkout.address.defaultSuffix': '(default)',
  'checkout.inlineSignIn.show': 'Already have an account? Sign in',
  'checkout.inlineSignIn.hide': 'Hide sign-in',
  'checkout.createAccountOptIn':
    "Create an account for faster checkout next time (we'll email you a password setup link)",
  'checkout.requiredHint': '* Required',
  'checkout.promoLine': 'Promo code',
  // Cart
  'cart.page.quantity': 'Quantity',
  // Orders
  'orderConfirmation.tax': 'Tax',
  'orderConfirmation.details': 'Order details',
  'orderConfirmation.paymentMethod': 'Payment method',
  'orderConfirmation.paymentMethod.stripe': 'Card (Stripe)',
  'orderConfirmation.paymentMethod.bacs': 'Bank transfer',
  'orderConfirmation.paymentMethod.cheque': 'Cheque',
  'orderConfirmation.paymentMethod.cod': 'Cash on delivery',
  'orderConfirmation.paymentMethod.cash': 'Cash',
  'orderConfirmation.paymentMethod.card-terminal': 'Card terminal',
  'orderConfirmation.paymentMethod.pos-split': 'Split payment',
  'orderConfirmation.shippingMethod': 'Shipping method',
  'orderHistory.loadFailed': 'We could not load your orders. Please try again.',
  'admin.setup.neededTitle': 'Your store setup needs installing',
  'admin.setup.neededBody':
    'The security rules and database indexes for v{version} are missing or out of date in your Firebase project, so some admin pages cannot load their data. Install them now; it takes a few seconds.',
  'admin.setup.install': 'Install now',
  'admin.setup.installing': 'Installing security rules and indexes…',
  'admin.setup.installedTitle': 'Store setup installed',
  'admin.setup.installedBody': 'Reload the page to load everything.',
  'admin.setup.installedBuilding':
    'Rules are live. New database indexes take a few minutes to build; some lists may show an error until they finish.',
  'admin.setup.reload': 'Reload',
  ...
  'order.status.on-hold': 'Awaiting payment',
  'orderDetail.title': 'Order #{id}',
  'orderDetail.placedOn': 'Placed on {date}',
  'orderDetail.back': 'Back to orders',
  'orderDetail.signIn': 'Sign in',
  'orderDetail.notFound': 'Order not found',
  'orderDetail.notFoundHint': 'This order does not exist or belongs to another account.',
  'orderDetail.progress': 'Order progress',
  'orderDetail.cancelled': 'This order was cancelled.',
  'orderDetail.step.placed': 'Placed',
  'orderDetail.step.paid': 'Paid',
  'orderDetail.step.processing': 'Processing',
  'orderDetail.step.shipped': 'Shipped',
  'orderDetail.step.delivered': 'Delivered',
  'orderDetail.deliverTo': 'Delivery address',
  'orderDetail.notes': 'Notes',
  'orderDetail.discountWithCode': 'Discount ({code})',
  'checkout.orderNotes': 'Order notes (optional)',
  'checkout.orderNotesPlaceholder': 'Delivery instructions, gift message…',
  'checkout.rate.arrives': 'arrives {dates}',
  'guestOrder.title': 'Track your order',
  'guestOrder.subtitle': 'Enter the order number and the email address you used at checkout.',
  'guestOrder.orderNumber': 'Order number',
  'guestOrder.email': 'Email',
  'guestOrder.submit': 'Track order',
  'guestOrder.notFound':
    "We couldn't find an order with that number and email. Double-check both and try again.",
  'guestOrder.lookupFailed': 'Lookup failed.',
  'guestOrder.orderHeading': 'Order #{id}',
  'guestOrder.placedOn': 'Placed {date}',
  'guestOrder.shippingTo': 'Shipping to',
  'guestOrder.haveAccount': 'Have an account?',
  'guestOrder.signIn': 'Sign in',
  ...
  'storefront.disabled.body': 'Online shopping is turned off for this store.',
  'storefront.notFound.title': 'Page not found',
  'storefront.notFound.body': '{path} doesn’t match any route.',
  'storefront.contentPage.empty': 'This page has no content yet. Edit it in /admin/pages.',
  'product.sizeOutOfStock': 'This size is out of stock',
  'product.gallery.noImages': 'No images',
  'product.gallery.viewImage': 'View image {index}',
  'product.gallery.previous': 'Previous image',
  'product.gallery.next': 'Next image',
  'product.related.title': 'You may also like',
  'product.viewProduct': 'View product',
  'product.editorial.storyDetails': 'Story & Details',
  'product.editorial.fromBuyers': 'From buyers',
  'product.tech.specifications': 'Specifications',
  'reviews.ratingLabel': 'Rating',
  'reviews.starsLabel': '{count, plural, one {# star} other {# stars}}',
  'navigation.footer.aboutUs': 'About us',
  'navigation.footer.privacy': 'Privacy',
  'navigation.footer.terms': 'Terms',
  'navigation.footer.contact': 'Contact',
  'navigation.footer.shippingReturns': 'Shipping & returns',
  'navigation.footer.sizeGuide': 'Size guide',
  'navigation.footer.faqs': 'FAQs',
  'faqs.category.orders': 'Orders & Shipping',
  'faqs.category.returns': 'Returns & Exchanges',
  'faqs.category.products': 'Products & Sizing',
  'faqs.category.account': 'Account & Payment',
  'faqs.category.general': 'General',
  'comingSoon.defaultMessage': 'We’re launching soon. Check back shortly.',
  'comingSoon.ariaLabel': 'Coming soon',
  'comingSoon.logoAlt': 'Logo',
  'journal.empty': 'No articles yet.',
  'search.loadFailed': 'Search is unavailable right now.',
  'search.retry': 'Try again',
  'collectionDetail.backToCollections': 'View all collections',
  'home.quote.attributionFallback': '— {brand}',
  'setup.steps.template': 'TEMPLATE',
  'setup.template.heading': 'Pick a starter template',
  'setup.template.subhead': 'Seed your storefront with sample content + theme, or start blank.',
  'setup.template.intro':
    'Pick a starter template to seed your storefront with sample products, categories, pages, and editorial content. You can change everything after, and apply a different template later from',
  'setup.template.introPath': 'Admin → Settings → Templates',
  'setup.template.introSuffix': 'Or start blank.',
  'setup.template.blankTag': 'blank',
  'setup.template.blankTitle': 'Start blank',
  'setup.template.blankDesc':
    'Skip the sample data and start with an empty storefront. You can apply a template later from the admin.',
  'setup.template.applyFailed': 'Template apply failed: {message}',
  'setup.template.applyFailedGeneric': 'Template apply failed.',
  'setup.summary.template': 'Template',

  // [worker-C keys: admin catalog, settings, plugins]
  'admin.confirm.deleteTitle': 'Delete?',
  'admin.confirm.removeTitle': 'Remove?',
  'admin.confirm.cancel': 'Cancel',
  'admin.confirm.delete': 'Delete',
  'admin.confirm.remove': 'Remove',
  'admin.loadFailed': 'Could not load data. Reload the page to try again.',
  'admin.settings.loadFailed': 'Could not load the current settings. Reload the page to try again.',
  'admin.categories.confirmDelete': 'Delete category "{name}"? This can’t be undone.',
  'admin.categories.confirmDeleteWithChildren':
    'Delete category "{name}"? {count, plural, one {Its # subcategory} other {Its # subcategories}} will move to the top level. This can’t be undone.',
  'admin.brands.confirmDelete':
    'Delete brand "{name}"? Products that reference it keep their stored value.',
  'admin.collections.confirmDelete': 'Delete collection "{name}"? This can’t be undone.',
  'admin.languages.confirmDelete': 'Delete language "{name}"? This can’t be undone.',
  'admin.languages.errors.duplicateCode': 'A language with code "{code}" already exists.',
  'admin.products.notFound': 'Product not found',
  'admin.products.notFoundHint': 'This product may have been deleted.',
  'admin.products.backToProducts': '← Back to products',
  'admin.products.validation.nameMin': 'Name must be at least 2 characters.',
  'admin.products.validation.brandRequired': 'Pick a brand.',
  'admin.products.validation.pricePositive': 'Enter a price of 0 or more.',
  'admin.products.validation.weightInvalid': 'Weight must be a number of 0 or more.',
  'admin.products.validation.categoryRequired': 'Pick a category.',
  'admin.products.validation.descriptionMin': 'Description must be at least 10 characters.',
  'admin.products.validation.imageUrlInvalid': 'Enter a valid image URL starting with https://',
  'admin.products.validation.imagesInvalid':
    'The highlighted images have an invalid URL — remove them and add them again.',
  'admin.products.validation.stockInvalid': 'Use a whole number of 0 or more.',
  'admin.products.validation.colorNameRequired': 'Give this color a name.',
  'admin.products.validation.colorNameDuplicate': 'Another color already uses this name.',
  'admin.products.validation.colorImageRequired': 'Add an image for this color.',
  'admin.products.validation.fixErrors': 'Fix the highlighted fields before saving.',
  'admin.products.colors.title': 'Color variants',
  'admin.products.colors.hint':
    'Each color shows as an image swatch on the product page; picking one swaps the gallery to its image. The first color is selected by default.',
  'admin.products.colors.name': 'Color name',
  'admin.products.colors.namePlaceholder': 'e.g. Black',
  'admin.products.colors.image': 'Swatch image',
  'admin.products.colors.add': 'Add color',
  'admin.products.colors.remove': 'Remove',
  'admin.products.colors.moveUp': 'Move color up',
  'admin.products.colors.moveDown': 'Move color down',
  'admin.products.mode.label': 'Editor layout',
  'admin.products.mode.full': 'Full form',
  'admin.products.mode.steps': 'Step-by-step',
  'admin.products.steps.basic': 'Basic info',
  'admin.products.steps.details': 'Details',
  'admin.products.steps.review': 'Review',
  'admin.products.steps.next': 'Next',
  'admin.products.steps.back': 'Back',
  'admin.products.steps.edit': 'Edit',
  'admin.products.review.name': 'Name',
  'admin.products.review.price': 'Price',
  'admin.products.review.brand': 'Brand',
  'admin.products.review.category': 'Category',
  'admin.products.review.uncategorised': 'Uncategorised',
  'admin.products.review.images': 'Images',
  'admin.products.review.sizes': 'Sizes & stock',
  'admin.products.review.untracked': 'untracked',
  'admin.products.review.colors': 'Color variants',
  'admin.products.review.status': 'Status',
  'admin.products.review.active': 'Active (visible in store)',
  'admin.products.review.hidden': 'Hidden',
  'admin.products.review.none': 'None',
  'admin.orders.backToOrders': 'Back to orders',

  // [worker-D keys: admin dashboard, misc admin]
  'admin.common.loadFailed': 'Could not load data. Check your connection and try again.',
  'admin.common.actionFailed': 'Action failed',
  'admin.common.deleteFailed': 'Delete failed',
  'admin.common.saveFailed': 'Save failed',
  'admin.common.deleted': 'Deleted',
  'admin.common.filter': 'Filter:',
  'admin.confirm.deleteNamedTitle': 'Delete “{name}”?',
  'admin.confirm.deleteBody': 'This cannot be undone.',
  'admin.dashboard.title': 'Dashboard',
  'admin.dashboard.subtitle': 'Quick snapshot of your store.',
  'admin.dashboard.loadFailed': 'Some dashboard numbers could not be loaded.',
  'admin.dashboard.retry': 'Retry',
  'admin.dashboard.card.products': 'Products',
  'admin.dashboard.card.orders': 'Orders',
  'admin.dashboard.card.revenue': 'Revenue',
  'admin.dashboard.card.pendingReviews': 'Pending reviews',
  'admin.dashboard.card.pendingQuestions': 'Pending questions',
  'admin.dashboard.relative.justNow': 'just now',
  'admin.dashboard.relative.minutes': '{count}m ago',
  'admin.dashboard.relative.hours': '{count}h ago',
  'admin.dashboard.relative.days': '{count}d ago',
  'admin.dashboard.relative.today': 'Today',
  'admin.dashboard.relative.yesterday': 'Yesterday',
  'admin.dashboard.relative.daysAgo': '{count, plural, one {# day ago} other {# days ago}}',
  'admin.dashboard.todos.loadFailed': 'Could not load the checklist',
  'admin.dashboard.todos.updateFailed': 'Update failed',
  'admin.dashboard.todos.addFailed': 'Add failed',
  'admin.dashboard.todos.deleteFailed': 'Delete failed',
  'admin.dashboard.todos.alreadySeeded': 'Checklist already seeded',
  'admin.dashboard.todos.seeded': '{count, plural, one {Added # setup task} other {Added # setup tasks}}',
  'admin.dashboard.todos.seedFailed': 'Seed failed',
  'admin.dashboard.todos.verifyNothing': 'Nothing new to mark done',
  'admin.dashboard.todos.verifyMarked': '{count, plural, one {Marked # item done} other {Marked # items done}}',
  'admin.dashboard.todos.verifyFailed': 'Verify failed',
  'admin.dashboard.todos.progress': '{done} / {total} complete ({pct}%)',
  'admin.dashboard.todos.verify': 'Verify progress',
  'admin.dashboard.todos.hideCompleted': 'Hide completed',
  'admin.dashboard.todos.addPlaceholder': 'Add a task…',
  'admin.dashboard.todos.add': '+ Add task',
  'admin.dashboard.todos.reseed': 'Re-seed defaults',
  'admin.dashboard.todos.allDone': 'All tasks completed — nice.',
  'admin.dashboard.todos.empty': 'No tasks yet. Use “Re-seed defaults” to add the setup checklist.',
  'admin.dashboard.todos.markDone': 'Mark “{title}” as done',
  'admin.dashboard.todos.markNotDone': 'Mark “{title}” as not done',
  'admin.dashboard.todos.setupBadge': 'Setup',
  'admin.dashboard.todos.showAll': 'Show all {count} tasks',
  'admin.dashboard.notifications.refresh': 'Refresh',
  'admin.dashboard.notifications.empty': 'All clear — no pending notifications.',
  'admin.dashboard.notifications.kind.update': 'Update',
  'admin.dashboard.notifications.kind.moderation': 'Moderation',
  'admin.dashboard.notifications.kind.inbox': 'Inbox',
  'admin.dashboard.searchTerms.subtitle':
    '{unique} unique · {total, plural, one {# total search} other {# total searches}}',
  'admin.dashboard.searchTerms.loadFailed': 'Failed to load search terms',
  'admin.dashboard.searchTerms.removed': 'Search term removed',
  'admin.dashboard.searchTerms.deleteFailed': 'Delete failed',
  'admin.dashboard.searchTerms.deleteBody': 'This removes the term from search analytics. It cannot be undone.',
  'admin.dashboard.searchTerms.clearAll': 'Clear all',
  'admin.dashboard.searchTerms.clearAllTitle':
    '{count, plural, one {Delete # search term?} other {Delete all # search terms?}}',
  'admin.dashboard.searchTerms.clearedAll': 'Removed {count} search terms',
  'admin.dashboard.searchTerms.clearFailed': 'Clear failed',
  'admin.dashboard.searchTerms.filterPlaceholder': 'Search in terms…',
  'admin.dashboard.searchTerms.sort.count': 'Most searched',
  'admin.dashboard.searchTerms.sort.recent': 'Most recent',
  'admin.dashboard.searchTerms.empty':
    'No customer searches yet. Terms will appear here once shoppers start searching.',
  'admin.dashboard.searchTerms.noMatch': 'No terms match your filter.',
  'admin.dashboard.searchTerms.col.term': 'Term',
  'admin.dashboard.searchTerms.col.searches': 'Searches',
  'admin.dashboard.searchTerms.col.last': 'Last searched',
  'admin.dashboard.searchTerms.col.first': 'First searched',
  'admin.dashboard.searchTerms.col.actions': 'Actions',
  'admin.dashboard.searchTerms.showAll': 'Show all {count} terms',
  'admin.notificationsBell.label': 'Notifications',
  'admin.notificationsBell.labelWithCount': 'Notifications ({count})',
  'admin.notificationsBell.allClear': 'All clear',
  'admin.notificationsBell.unread': '{count} unread',
  'admin.notificationsBell.empty': 'No notifications.',
  'admin.notificationsBell.viewAll': 'View all notifications →',
  'admin.profileMenu.accountMenu': 'Account menu',
  'admin.profileMenu.viewStorefront': 'View storefront',
  'admin.profileMenu.myProfile': 'My profile',
  'admin.profileMenu.signOut': 'Sign out',
  'admin.profileMenu.signOutFailed': 'Sign-out failed',
  'admin.guard.signInTitle': 'Sign in required',
  'admin.guard.signInBody': 'Admin pages require an authenticated account.',
  'admin.guard.signIn': 'Sign in',
  'admin.guard.deniedTitle': 'Access denied',
  'admin.guard.deniedBody': 'Your account doesn’t have the admin role. Three paths to fix:',
  'admin.guard.copied': 'Copied',
  'admin.guard.copyUid': 'Copy UID',
  'admin.guard.claiming': 'Claiming…',
  'admin.guard.claimAdmin': 'Claim admin role',
  'admin.guard.claimFailed': 'Failed to claim admin role.',
  'admin.users.total': '{count, plural, one {# user} other {# users}}',
  'admin.multiSelect.label': 'Select',
  'admin.multiSelect.searchPlaceholder': 'Search…',
  'admin.multiSelect.noMatches': 'No matches.',
  'admin.multiSelect.noMatchesFor': 'No matches for “{query}”.',
  'admin.multiSelect.create': 'Create “{name}”',
  'admin.multiSelect.remove': 'Remove {name}',
  'admin.contacts.openDetail': 'Open message from {name}',
  'admin.importExport.import.failed': 'Import failed — nothing was changed. Check the file and try again.',
  'admin.subscribers.title': 'Subscribers',
  'admin.subscribers.total': '{count, plural, one {# subscriber} other {# subscribers}}',
  'admin.subscribers.searchPlaceholder': 'Search by email…',
  'admin.subscribers.empty': 'No subscribers.',
  'admin.subscribers.col.email': 'Email',
  'admin.subscribers.col.subscribedAt': 'Subscribed at',
  'admin.subscribers.col.actions': 'Actions',
  'admin.subscribers.remove': 'Remove',
  'admin.subscribers.removed': 'Subscriber removed',
  'admin.subscribers.removeTitle': 'Remove {email}?',
  'admin.subscribers.removeBody': 'They will no longer receive your newsletter. This cannot be undone.',
  'admin.faqs.title': 'FAQs',
  'admin.faqs.subtitle': 'Manage the questions shown on the public FAQs page.',
  'admin.faqs.new': '+ New FAQ',
  'admin.faqs.empty': 'No FAQs yet.',
  'admin.faqs.col.order': 'Order',
  'admin.faqs.col.category': 'Category',
  'admin.faqs.col.question': 'Question',
  'admin.faqs.col.actions': 'Actions',
  'admin.faqs.editTitle': 'Edit FAQ',
  'admin.faqs.newTitle': 'New FAQ',
  'admin.faqs.field.category': 'Category',
  'admin.faqs.field.question': 'Question',
  'admin.faqs.field.answer': 'Answer',
  'admin.faqs.field.order': 'Display order',
  'admin.faqs.requiredFields': 'Question and answer are required',
  'admin.faqs.created': 'FAQ created',
  'admin.faqs.updated': 'FAQ updated',
  'admin.faqs.deleted': 'FAQ deleted',
  'admin.journal.titleRequired': 'Title is required',
  'admin.promoCodes.title': 'Promo codes',
  'admin.promoCodes.subtitle': 'Create discount codes validated by the Stripe Cloud Function at checkout.',
  'admin.promoCodes.new': '+ New code',
  'admin.promoCodes.empty': 'No promo codes yet.',
  'admin.promoCodes.col.code': 'Code',
  'admin.promoCodes.col.type': 'Type',
  'admin.promoCodes.col.value': 'Value',
  'admin.promoCodes.col.minOrder': 'Min order',
  'admin.promoCodes.col.maxDiscount': 'Max discount',
  'admin.promoCodes.col.status': 'Status',
  'admin.promoCodes.col.actions': 'Actions',
  'admin.promoCodes.type.percentage': 'Percentage',
  'admin.promoCodes.type.fixed': 'Fixed amount',
  'admin.promoCodes.active': 'Active',
  'admin.promoCodes.inactive': 'Inactive',
  'admin.promoCodes.editTitle': 'Edit promo code',
  'admin.promoCodes.newTitle': 'New promo code',
  'admin.promoCodes.field.code': 'Code',
  'admin.promoCodes.field.type': 'Type',
  'admin.promoCodes.field.value': 'Value ({unit})',
  'admin.promoCodes.field.minOrder': 'Min order amount ({currency}, optional)',
  'admin.promoCodes.field.maxDiscount': 'Max discount ({currency}, optional)',
  'admin.promoCodes.codeRequired': 'Code is required',
  'admin.promoCodes.error.percentageRange': 'Percentage must be more than 0 and at most 100.',
  'admin.promoCodes.error.fixedPositive': 'Fixed amount must be more than 0.',
  'admin.promoCodes.error.minOrderNegative': 'Minimum order amount cannot be negative.',
  'admin.promoCodes.error.maxDiscountNegative': 'Maximum discount cannot be negative.',
  'admin.promoCodes.created': 'Promo code created',
  'admin.promoCodes.updated': 'Promo code updated',
  'admin.promoCodes.deleted': 'Promo code deleted',
  'admin.reviews.deleteReviewTitle': 'Delete this review?',
  'admin.reviews.deleteQuestionTitle': 'Delete this question?',
  'admin.products.clear': 'Clear',
  'admin.products.clearFilters': 'Clear ({count})',
  'pageBuilder.editImageHint': 'Click to edit this image in the panel',
  'pageBuilder.field.linkPlaceholder': '/path or https://…',
  'pageBuilder.style.maxWidthPlaceholder': 'e.g. 720px',
  'pageBuilder.credit.source': 'Source',

  // [worker-E keys]
  'admin.appearance.copy.title': 'Storefront copy',
  'admin.appearance.copy.subtitle':
    'Short lines the Electronics and Home Goods template chrome show in their announcement bar, pre-footer strip and pull-quote. A band stays hidden until its line is filled in; the default storefront ignores these.',
  'admin.appearance.copy.announcement.label': 'Announcement bar',
  'admin.appearance.copy.announcement.placeholder': 'Free delivery on orders over 50',
  'admin.appearance.copy.announcement.help': 'One short line across the top of every page (Electronics template). Only promise what you actually offer.',
  'admin.appearance.copy.tagline.label': 'Tagline',
  'admin.appearance.copy.tagline.placeholder': 'Tested by us before it ships to you',
  'admin.appearance.copy.tagline.help': 'Shown in the pre-footer strip and the homepage spec strip (Electronics template). Falls back to your brand description.',
  'admin.appearance.copy.quote.label': 'Pull-quote',
  'admin.appearance.copy.quote.placeholder': 'We make fewer pieces, and make them to last.',
  'admin.appearance.copy.quote.help': 'The quote on the homepage and the footer sign-off (Home Goods template). Falls back to your brand description.',
  'admin.appearance.copy.quoteAttribution.label': 'Quote attribution',
  'admin.appearance.copy.quoteAttribution.placeholder': 'The founders',
  'admin.appearance.copy.quoteAttribution.help': 'Printed under the pull-quote. Falls back to your brand name.',
  'admin.appearance.copy.saved': 'Storefront copy saved',
  'admin.appearance.copy.saveFailed': 'Could not save storefront copy',
  'imageUpload.upload': 'Upload',
  'imageUpload.replace': 'Replace',
  'imageUpload.remove': 'Remove',
  'imageUpload.removeImage': 'Remove image',
  'imageUpload.noImage': 'No image',
  'imageUpload.pasteUrl': 'or paste URL',
  'colorField.clear': 'Clear color',
};
